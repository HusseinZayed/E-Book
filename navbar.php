         ...
         <div class="collapse navbar-collapse navbar-ex1-collapse">
             ...
             <ul class="nav navbar-nav navbar-left">
                 ...
                 <li class="dropdown">
                     ...
                     <ul class="dropdown-menu">
                         <li><a href="results.php">Economics</a></li>
                         <li><a href="results.php">Programming</a></li>
                         <li><a href="results.php">Health</a></li>
                         <li><a href="results.php">Politics</a></li>
                     </ul>
                 </li>
                 <li class="dropdown">
                     <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                     ...
                     <ul class="dropdown-menu">
                         <li><a href="results.php">Short Story</a></li>
                         <li><a href="results.php">Novels</a></li>
                     </ul>
                 </li>
